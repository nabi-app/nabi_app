...
import 'package:nabi_app/di/api_module.dart' as _i14;
import 'package:nabi_app/di/app_module.dart' as _i15;
import 'package:nabi_app/domain/model/sign_up_transmission_model.dart' as _i11;
...
import 'package:nabi_app/presentaion/login/login_view_model.dart' as _i13;
import 'package:nabi_app/presentaion/sign_up/sign_up_view_model.dart' as _i10;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factoryParam<_i10.SignUpViewModel, _i11.SignUpTransmissionModel,
        dynamic>((
      _signUpTransmissionModel,
      _,
    ) =>
        _i10.SignUpViewModel(
          gh<_i8.UserAuthRepository>(),
          _signUpTransmissionModel,
        ));
    gh.factory<_i12.SplashViewModel>(
        () => _i12.SplashViewModel(gh<_i8.UserAuthRepository>()));
    gh.factory<_i13.LoginViewModel>(
        () => _i13.LoginViewModel(gh<_i8.UserAuthRepository>()));
    return this;
  }
}
